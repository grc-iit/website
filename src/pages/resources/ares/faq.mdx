...
Each compute node has one local NVMe SSD, one SATA SSD, and one SATA HDD. They are mounted at /mnt/nvme, /mnt/ssd and /mnt/hdd, respectively. Every user has local directories in /mnt/nvme/USERNAME, /mnt/ssd/USERNAME and /mnt/hdd/USERNAME on each compute node.
