...
Your cluster administrator can be reached via <grc+aresadmin@iit.edu> and someone will get back to you.
...
|  SATA HDD | Samsung 860 Evo                                                       |      1TB      |
|  Ethernet | Seagate LM049-2GH172                                                  |  10 Gigagbit  |
| RoCE/RDMA | Mellanox ConnectX-4 Lx 1x40GbE QSFP. |   40 Gigabit  |

## Accessing the Cluster

To access the Ares cluster, you will need to SSH using your IIT assigned username and SSH key. If you encounter any issues with access, please contact the cluster administrator.
